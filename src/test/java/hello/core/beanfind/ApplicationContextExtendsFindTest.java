...
//        DiscountPolicy bean = ac.getBean(DiscountPolicy.class);
    ...
    static class TestConfig {
        @Bean
        public DiscountPolicy rateDiscountPolicy() { // DiscountPolicy 타입으로 해놓는 이유는 ?
            return new RateDiscountPolicy(); // "역할"을 보기 위해서 (구체적인 것으로 해도 되지만, 역할로 해놓는 것이 의존관계 주입할 때도 좋다)
        }
